    ...
    render() {
        ...
        const prevPage =
            currentPage - 1 === 1
                ...
                : `/category/worst-new-music/${currentPage - 1}`
        const nextPage = `/category/worst-new-music/${currentPage + 1} `
...
export const pageQuery = graphql`
    query WorstNewMusicQuery($skip: Int!, $limit: Int!) {
        allContentfulBlog(
